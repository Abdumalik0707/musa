...
const dict = {
  uz: {
    ...
    story_title: "Har kuni shirinlik ulashamiz",
    story_desc: "Musa jamoasi eng sifatli va tabiiy mahsulotlarni tanlab, ularni sizga eng qisqa muddatda yetkazib beradi. Har bir buyurtma — bizning mas'uliyatimiz.",
    story_btn: "Batafsil",
    offer_label: "Cheklangan taklif",
    offer_title: "2 ta olsangiz, 1 tasi tekin!",
    offer_desc: "Ma'lum marojni turlarida amal qiladi",
    offer_btn: "Buyurtma berish",
  },
  ru: {
    nav_products: "Товары",
    ...
    story_title: "Дарим сладкие моменты каждый день",
    story_desc: "Команда Musa отбирает только самые качественные и натуральные продукты и доставляет их вам в кратчайшие сроки. Каждый заказ — наша ответственность.",
    story_btn: "Подробнее",
    offer_label: "Ограниченное предложение",
    offer_title: "Купи 2, получи 1 бесплатно!",
    offer_desc: "Действует на отдельные виды мороженого",
    offer_btn: "Заказать",
  },
  en: {
    ...
    story_title: "Sharing sweet moments every day",
    story_desc: "The Musa team hand-picks only the finest natural products and delivers them to you as fast as possible. Every order is our responsibility.",
    story_btn: "Learn more",
    offer_label: "Limited time offer",
    offer_title: "Buy 2, get 1 free!",
    offer_desc: "Valid on selected ice cream flavors",
    offer_btn: "Order now",
  },
} as const;
